...
export default function Contact(props) {
  ...
  const onConfirm = () => {
    ...
    axios
      .get(
        "https://us-central1-material-ui-course-3ebc7.cloudfunctions.net/sendMail", {params: {
          name: name,
          email: email,
          phone: phone,
          message: message
      ...
      .catch((err) => {setLoading(false); setAlert({open: true, message: "Something went wrong, please try agaiin!", backgroundColor: "#FF3232"})});
  };
          ...
          <Grid container direction="column">
            ...
            <Grid item container style={{ marginBottom: "2em" }}>
              ...
              <Grid item>
                ...
                >
                  <a
                    href="mailto:charlene.j8234@gmail.com"
                    style={{ textDecoration: "none", color: "inherit" }}
                  >
                    zachary@gmail.com
                  </a>
