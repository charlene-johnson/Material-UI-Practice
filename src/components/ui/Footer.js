    ...
    return ( 
        <footer className={classes.footer}>
            ...
            <Grid container justify="flex-end" spacing={2} className={classes.socialContainer}>
                <Grid item component={"a"} href="https://www.facebook.com/charlene.johnson8" rel="noopener noreferrer" target="_blank">
                    <img alt ='facebook logo' src={facebook} className={classes.icon} />
                </Grid>
                 <Grid item component={"a"} href="https://twitter.com/CharJ8234" rel="noopener noreferrer" target="_blank">
                    <img alt ='twitter logo' src={twitter} className={classes.icon} />
                </Grid>
                 <Grid item component={"a"} href="https://www.instagram.com/natsukoizuki/" rel="noopener noreferrer" target="_blank">
